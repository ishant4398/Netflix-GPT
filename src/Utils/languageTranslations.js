const languageTranslations = {
  en: {
    ...
    newToNetflix: "New to Moviesflix-GPT ? Sign Up now.",
  ...
  hindi: {
    ...
    newToNetflix: "मूवीफ्लिक्स-जीपीटी पर नए हैं? साइन अप करें.",
  ...
  spanish: {
    ...
    newToNetflix: "¿Nuevo en Moviesflix-GPT ? Regístrate ahora.",
